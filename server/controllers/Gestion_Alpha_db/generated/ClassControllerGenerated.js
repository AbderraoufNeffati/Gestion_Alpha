...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findBy_course/:key", authorize([]), ClassController.findBy_course);
  ...
  */
  findBy_course: async (req, res) => {
    try {
      const result = await ClassModel.findBy_course(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
